document.addEventListener("DOMContentLoaded", () => {
    ...
    const translations = {
        en: {
            ...
            a1: "With us, you get a full service for a successful business. Instead of hiring different freelancers, GRAND Ellite offers a complete package.",
            q2: 'What does "Sales-Oriented Website" actually mean?',
            a2: "In GRAND Ellite, web design isn't just about visuals—it's a sales strategy.",
            cont_sub: "Contact",
        ...
        ka: {
            ...
            a1: "ჩვენთან თქვენ იღებთ მთლიან სერვისს: ვებ-საიტის აწყობა, რეკლამა, მონტაჟი და სხვა.",
            q2: 'რას ნიშნავს „გაყიდვებზე ორიენტირებული საიტი“?',
            a2: "GRAND Ellite-ში ვებ-დიზაინი გაყიდვების სტრატეგიაა.",
            cont_sub: "კონტაქტი",
